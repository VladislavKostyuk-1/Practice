...
# !!!Примітка - код цього класу ідентичний до коду в ResourceStatManager, єдина відмінність - цей
# клас є дочирнім до класу Node, його слід використовувати якщо стати не зберігаються у файлі
# формату .tres
